...
int DotReader::lineReader(){
	...
	std::cout << "[TEST] starting generateComponentList(filen)" << std::endl;
	generateComponentList();
	std::cout << "[TEST] finished generateComponentList(filen)" << std::endl;


	generateConnectionMap();
	std::cout << "[TEST] finished generateConnectionMap(filen)" << std::endl;
...
void DotReader::generateComponentList(){
	for(int i = 0; i < components_in_netlist; i++){
		...
		std::cout << "[TEST] Calling the constructor of component: " << nodes[i].name << std::endl;
		comp->index = i;
		...
		std::cout << "[TEST] finishing the construction of component: " << nodes[i].name << std::endl;
	}
}
