...
//
//Type Component Classes (To be moved to their respective class files)
class FueqComponent : public FloatingArithmeticComponent{
	public:
		FueqComponent(Component& c);
};


//Type Component Classes (To be moved to their respective class files)
class FuneComponent : public FloatingArithmeticComponent{
	public:
		FuneComponent(Component& c);
};

//Type Component Classes (To be moved to their respective class files)
class FugtComponent : public FloatingArithmeticComponent{
	public:
		FugtComponent(Component& c);
};


//Type Component Classes (To be moved to their respective class files)
class FugeComponent : public FloatingArithmeticComponent{
	public:
		FugeComponent(Component& c);
};


//Type Component Classes (To be moved to their respective class files)
class FultComponent : public FloatingArithmeticComponent{
	public:
		FultComponent(Component& c);
};


//Type Component Classes (To be moved to their respective class files)
class FuleComponent : public FloatingArithmeticComponent{
	public:
		FuleComponent(Component& c);
};
