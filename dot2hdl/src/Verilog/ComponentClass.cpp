...
Component* Component::castToSubClass(Component* component){
	if(type == COMPONENT_START){
		...
		if(op == OPERATOR_ADD){
			...
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FUEQ){
			FueqComponent* obj = new FueqComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FUNE){
			FuneComponent* obj = new FuneComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FUGT){
			FugtComponent* obj = new FugtComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FUGE){
			FugeComponent* obj = new FugeComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FULT){
			FultComponent* obj = new FultComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FULE){
			FuleComponent* obj = new FuleComponent(*this);
			component = (Component *)obj;
			return component;
