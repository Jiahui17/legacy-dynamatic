...
#define OPERATOR_FUEQ  "fcmp_ueq_op"
#define OPERATOR_FUNE  "fcmp_une_op"
#define OPERATOR_FUGT  "fcmp_ugt_op"
#define OPERATOR_FUGE  "fcmp_uge_op"
#define OPERATOR_FULT  "fcmp_ult_op"
#define OPERATOR_FULE  "fcmp_ule_op"
